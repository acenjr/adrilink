...
export default function MobileHero() {
  return (
    <section className="block md:hidden w-full bg-primary/90 border-b-4 border-primary">
      {/* Top Titles */}
      <div className="text-center text-white pt-8 pb-4 px-4">
      ...
      <div className="text-center text-white px-4 pt-6 pb-8">
        ...
        <div className="flex flex-col gap-3 items-center mb-6">
          ...
          <a href="#contact" className="w-full">
            <Button size="lg" variant="outline" className="w-full border-accent text-white hover:bg-white hover:text-primary text-base bg-transparent">Get Quote</Button>
          </a>
        </div>
        <div className="grid grid-cols-2 gap-4 max-w-xs mx-auto">
          <div className="text-center">
            <div className="text-xl font-bold text-white">2022</div>
